...
public class ListViewAdapter extends ArrayAdapter<WorldPopulation> {
  ...
  public View getView(int position, View view, ViewGroup parent) {
    ...
    if (view == null) {
      ...
      holder.rank = (TextView) view.findViewById(R.id.trackname);
      holder.country = (TextView) view.findViewById(R.id.channel);
      holder.population = (TextView) view.findViewById(R.id.instrument);
      // Locate the ImageView in listview_item.xml
      holder.flag = (TextView) view.findViewById(R.id.onoff);
      view.setTag(holder);
    } else {
    ...
    holder.flag.setText(worldpopulationlist.get(position)
        .getFlag());
    return view;
  }
